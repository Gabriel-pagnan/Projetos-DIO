function start(){
    ...
    function explosao3(amigoX,amigoY) {
        $("#fundoGame").append("<div id='explosao3' class='anima3'></div");
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia'><h3 onClick=reiniciaJogo()>Jogar Novamente</h3></div>");
    }
}
